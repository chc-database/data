...
- [**PRESENT_AT**](#present_at): This links Person nodes to Institution, General Area, or Event nodes.
- [**RELATED_TO**](#related_to): This links Person nodes to other Person nodes.
- [**INVOLVED_WITH**](#involved_with): This links Person nodes to Publication nodes.
