...
To add auxiliary links to your site (in the upper right on all pages), add it to the `aux_links` [configuration option]({{ site.baseurl }}{% link docs/chcd_design.md %}#aux-links) in your site's `_config.yml` file.
